...
public class ODataToBsonConverter {
    ...
    /**
     * Converts a Java String into the correct BSON-typed object
     * based on the given OData EDM type.
     *
...
//                throw new UnsupportedOperationException("Complex types require JSON parsing into Document");
