...
public class Example2Controller {
  ...
  @Inject private PatchHelper patchHelper;
  ...
  public Response getExample(@PathParam("id") UUID id) throws Exception {
    ...
    savedModel =
        openApiJsonMapper.coerceMongoDecodedTypesToOpenApiJavaTypesV2(
            savedModel, "src/main/resources/example2_openapi.yaml", "Example2");
    return Response.ok(mapper.writerWithDefaultPrettyPrinter().writeValueAsString(savedModel))
        .build();
  }
  ...
  public Response saveExample(Map<String, Object> body) throws Exception {
    Map<String, Object> coercedMap =
        openApiJsonMapper.coerceRawJsonTypesToOpenApiJavaTypes(
            body, "src/main/resources/example2_openapi.yaml", "Example2");
  ...
  @Consumes(MediaType.APPLICATION_JSON)
  @SecuredExample2
  public Response saveExampleWithId(
      @PathParam("id") UUID id, Map<String, Object> body, @Context UriInfo uriInfo)
      throws Exception {
    Map<String, Object> coercedMap =
        openApiJsonMapper.coerceRawJsonTypesToOpenApiJavaTypes(
            body, "src/main/resources/example2_openapi.yaml", "Example2");
    ...
    try {
      savedModel =
          exampleService.saveAndUpdate(id, coercedMap, Map.copyOf(uriInfo.getQueryParameters()));
  ...
  @Consumes(MediaType.APPLICATION_JSON)
  @SecuredExample2
  public Response updateExampleWithId(
      @PathParam("id") UUID id, Map<String, Object> body, @Context UriInfo uriInfo)
      throws Exception {
    return updateExample(id, body, Map.copyOf(uriInfo.getQueryParameters()));
  }

  private Response updateExample(UUID id, Map<String, Object> body, Map<String, Object> queryParams)
      throws Exception {
    Map<String, Object> coercedMap =
        openApiJsonMapper.coerceRawJsonTypesToOpenApiJavaTypes(
            body, "src/main/resources/example2_openapi.yaml", "Example2");
  ...
  @Path("/simple-query")
  @Produces(MediaType.APPLICATION_JSON)
  public Response simpleFilterQuery(
        ...
        new QueryResponse(
            results.stream()
                .map(
                    rec -> {
                      try {
                        return openApiJsonMapper.coerceMongoDecodedTypesToOpenApiJavaTypesV2(
                            rec, "src/main/resources/example2_openapi.yaml", "Example2");
                      } catch (Exception e) {
                        throw new RuntimeException(e);
                      }
                    })
                .toList(),
            exampleService.explain(filters, orders, select));
    return Response.ok(mapper.writerWithDefaultPrettyPrinter().writeValueAsString(queryResponse))
        .build();
  }
  ...
  @Path("/simple-query")
  @Produces(MediaType.APPLICATION_JSON)
  public Response simpleFilterQuery(String pipelineJson) throws Exception {
