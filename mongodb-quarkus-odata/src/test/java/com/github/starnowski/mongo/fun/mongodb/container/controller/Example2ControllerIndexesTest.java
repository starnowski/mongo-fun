...
class Example2ControllerIndexesTest {
    ...
    public static Stream<Arguments> provideShouldReturnResponseStringBasedOnFiltersExample2() {
        return Stream.of(
                Arguments.of(TEST_CASE_NESTED_OBJECT_TOKENS_ANY_T_T_EQ_FIRST_EXAMPLE_AND_NESTED_OBJECT_NUMBERS_ANY_T_T_GT_5_AND_T_LT_27, "FETCH + IXSCAN")
        );
    }
    ...
    public void shouldReturnResponseStringBasedOnFiltersExample2(List<String> filters, String firstStageWinningPlan) throws IOException, JSONException {
        // GIVEN
