...
class Example2ControllerTest extends AbstractExample2ControllerTest {
  ...
  public static Stream<Arguments> provideShouldReturnResponseBasedOnFilters() {
    return Stream.of(
        ...
        Arguments.of(
            ...
            "COLLSCAN"),
        Arguments.of(
            List.of("toupper(plainString) eq 'EOMTTHYHVNLWUZNRCBAQKXI'"),
            "examples/query/responses/example2_1.json",
            "COLLSCAN"),
        Arguments.of(
            ...
            "COLLSCAN"),
        Arguments.of(
            List.of("plainString in ('Some text', 'no such text')"),
            "examples/query/responses/example2_2.json",
            "COLLSCAN"),
        Arguments.of(
        ...
        Arguments.of(
            ...
            "COLLSCAN"),
        Arguments.of(
            List.of("tags/any(t:t in ('developer', 'LLM'))"),
            "examples/query/responses/example2_3.json",
            "COLLSCAN"),

        // String functions
        Arguments.of(
            List.of("tolower(plainString) eq 'poem'"),
            "examples/query/responses/example2_3.json",
            "COLLSCAN"),
        Arguments.of(
            List.of("toupper(plainString) eq 'POEM'"),
            "examples/query/responses/example2_3.json",
            "COLLSCAN"),
        Arguments.of(
            List.of("length(plainString) eq 4"),
            "examples/query/responses/example2_3.json",
            "COLLSCAN"));
  }
  ...
  public static Stream<Arguments> provideShouldReturnResponseBasedOnFiltersArrayTypes() {
    return Stream.of(
        ...
        Arguments.of(
            ...
            "COLLSCAN"),
        Arguments.of(
            List.of("tags/any(t:startswith(t,'dev'))"),
            "examples/query/responses/example2_3.json",
            "COLLSCAN"),
        Arguments.of(
            List.of("tags/any(t:startswith(t,'dev') and length(t) eq 9)"),
            "examples/query/responses/example2_3.json",
            "COLLSCAN"),
        Arguments.of(
            List.of("tags/any(t:length(t) eq 13)"),
            "examples/query/responses/example2_1.json",
            "COLLSCAN"),
        Arguments.of(
            List.of("tags/any(t:tolower(t) eq 'developer')"),
            "examples/query/responses/example2_3.json",
            "COLLSCAN"),
        Arguments.of(
            List.of("tags/any(t:startswith(t,'spider') and endswith(t, 'web'))"),
            "examples/query/responses/example2_2.json",
            "COLLSCAN"),
        Arguments.of(
            List.of("tags/any(t:startswith(t,'spider') and t eq 'spiderweb')"),
            "examples/query/responses/example2_2.json",
            "COLLSCAN"),
        Arguments.of(
            List.of("tags/any(t:startswith(t,'spider') and t ne 'spiderweb')"),
            "examples/query/responses/example2_1.json",
            "COLLSCAN"),
        Arguments.of(
            List.of(
  ...
  public static Stream<Arguments> provideShouldReturnResponseStringBasedOnFilters() {
    return Stream.of(
        Arguments.of(
            List.of("uuidProp eq b921f1dd-3cbc-0495-fdab-8cd14d33f0aa"), ALL_EXAMPLES_IN_RESPONSE),
        //                Arguments.of(List.of("trim(concat('  ', plainString, '  ')) eq 'Poem'"),
  ...
  @Test
  public void shouldSaveAndReturnTheSameGeneratedExampleForGetByIdEndpoint()
    ...
    // THEN
    ExtractableResponse<Response> response =
        given().when().get("/examples2/{id}", uuid).then().statusCode(200).extract();
    System.out.println("Response payload:");
    System.out.println(response.asPrettyString());
    JSONAssert.assertEquals(json, response.asString(), true);
  ...
  @Test
  public void shouldSaveAndReturnBadRequestWhenTryingToInsertDocumentWithSameId()
      throws IOException, JSONException {
    // GIVEN
    UUID uuid = UUID.randomUUID();
    Example2Dto dto = generator.nextObject(Example2Dto.class);
  ...
  @Test
  public void shouldSaveAndPatchModelWithJsonPatchSpecification()
      throws IOException, JSONException {
    // GIVEN
    UUID uuid = UUID.randomUUID();
    Example2Dto dto = generator.nextObject(Example2Dto.class);
  ...
  @Test
  public void shouldSaveAndPatchModelWithMergePatchSpecification()
      throws IOException, JSONException {
    // GIVEN
    UUID uuid = UUID.randomUUID();
    Example2Dto dto = generator.nextObject(Example2Dto.class);
  ...
  public void shouldReturnBadRequestForInvalidPayload(
      String requestFile, String expectedResponseFilePath) throws IOException, JSONException {
    // GIVEN
    String expectedResponse =
        Files.readString(
            Paths.get(
                new File(
                        getClass().getClassLoader().getResource(expectedResponseFilePath).getFile())
                    .getPath()));
  ...
  public void shouldReturnResponseBasedOnFilters(
      List<String> filters, String expectedResponseFilePath) throws IOException, JSONException {
    // GIVEN
    String expectedResponse =
        Files.readString(
            Paths.get(
