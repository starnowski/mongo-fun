...
class Example2ControllerJsonPatchTest {
  ...
  @Test
  public void shouldSaveAndFailPatchModelWithJsonPatchSpecification()
  ...
  @Disabled
  @Test
  public void shouldSaveAndFailPatchModel222WithJsonPatchSpecification()
      throws IOException, JSONException {
    // GIVEN
    UUID uuid = UUID.randomUUID();
    ...
    //                .body("""
    //                        [
    //                          { "op": "add", "path": "/nestedObject/tokens/-", "value": "last
    // token" }
    //                        ]
    //                        """)//doubleValue
    //                //{ "op": "add", "path": "/nestedObject/tokens/-", "value": "last token" }
  ...
  @Test
  public void shouldSaveAndFailPatchModelWithJsonPatchSpecificationWithTestOp()
      throws IOException, JSONException {
    // GIVEN
    UUID uuid = UUID.randomUUID();
