            ...
            .runCommand(
                new Document(
                    ...
                    new Document("_id", rsName)
                        .append(
                            "members",
                            List.of(new Document("_id", 0).append("host", "localhost:" + port)))));
        ...
        Awaitility.await()
            ...
            .until(
                () -> {
                  ...
                  return status.getList("members", Document.class).stream()
                      .anyMatch(m -> "PRIMARY".equals(m.getString("stateStr")));
                });
